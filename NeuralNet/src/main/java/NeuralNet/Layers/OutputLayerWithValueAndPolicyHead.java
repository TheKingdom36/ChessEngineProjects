 ...
 */
public class OutputLayerWithValueAndPolicyHead extends FullyConnectedLayer {
    ...
    public OutputLayerWithValueAndPolicyHead(int numOfHiddenNodes, int numOfPolicyOutputNodes) {
    ...
    public OutputLayerWithValueAndPolicyHead(int numOfHiddenNodes, double[] actualValue, double[][] actualPolicy, int numOfPolicyOutputNodes) {
        super(numOfHiddenNodes);
